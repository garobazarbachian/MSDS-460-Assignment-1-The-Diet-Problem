print(f"Total servings of all items: {sum(var.varValue for var in prob.variables())}")
...
# Additional constraint to ensure at least one serving of each food item per week
